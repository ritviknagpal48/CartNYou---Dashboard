        ...
        >
          ...
          >
            ...
            <div className="grid grid-cols-1  gap-x-6 gap-y-2 md:grid-cols-2">
              <div className="flex flex-col items-start justify-center w-full ">
                ...
                <Form.Item style={{ width: "100%" }}>
                  <Select
                    ...
                    defaultValue={
                      values.counrty_origin.value || values.counrty_origin
                    }
                    allowClear
                  >
              ...
              <div className="flex flex-col items-start justify-center w-full ">
                ...
                <Form.Item style={{ width: "100%" }}>
                  <Select
                    ...
                    defaultValue={
                      values.measurement_unit.value || values.measurement_unit
                    }
                    allowClear
                  >
                    {measurment_array ? (
                      measurment_array.map((data, index) => {
                        return (
              ...
              <div className="flex flex-col items-start justify-center w-full ">
                <label className="pb-2">GST Type</label>
                <Form.Item style={{ width: "100%" }}>
                  <Select
...
ProductDetailForm.contextType = AuthContext;
