    ...
    <div className={clsx(classes.wrapper, className)}>
      ...
      <div className={classes.wrapper_inner} id={'wrapper_inner'}>
        ...
        >
          ...
          <span className={classes.tooltip_popup}>Dashboard</span>
        </Link>
        <Link
          to="/app/products"
          className={clsx(classes.menu_item, {
        ...
        >
          ...
          <span className={classes.tooltip_popup}>Products</span>
        </Link>
        <Link
          to="/app/orders"
          className={clsx(classes.menu_item, {
        ...
        <Link
          to="/app/warehouses"
          className={clsx(classes.menu_item, {
            [classes.menu_active]: activeMenu === "warehouses",
            [classes.menu_normal]: activeMenu !== "warehouses",
          })}
        >
          <svg
            className={"h-5 w-5 mr-2"}
          ...
          <span className={classes.tooltip_popup}>Warehouses</span>
        </Link>
      </div>
    </div>
  );
